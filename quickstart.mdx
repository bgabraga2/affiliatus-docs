...
<AccordionGroup>
  ...
  <Accordion icon="info-circle" title="Como funciona a segurança">
    ...
    1. De qual domínio veio a solicitação 2. Se esse domínio está na sua lista
    de autorizados 3. Se estiver, o evento é registrado 4. Se não estiver, o
    evento é bloqueado **Isso protege você contra:** - Pessoas criando
    conversões falsas - Fraudes no sistema de afiliados - Cliques e eventos
    vindos de lugares não autorizados
    <Warning>
      Sem adicionar seu domínio, NENHUM evento será registrado! É o primeiro
      passo obrigatório.
    </Warning>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion icon="clipboard-check" title="Aprovar conversões">
    ...
    vendas. Cada conversão tem 4 status possíveis: - **Pendente**: Aguardando
    sua aprovação - **Aprovada**: Você validou, a comissão está liberada -
...
<AccordionGroup>
  ...
  <Accordion icon="check-double" title="Marcar como pago">
    ...
    **Processando**: Você está fazendo a transferência 3. **Pago**:
    Transferência concluída Quando você realmente transferir o dinheiro, marque
    como **"Pago"** e adicione o ID da transação.
    <Note>
