...
<CardGroup cols={2}>
  <Card
    ...
    icon="plus"
    href="/api-reference/affiliates/create-affiliate"
  >
  ...
  <Card
    ...
    icon="list"
    href="/api-reference/affiliates/list-affiliates"
  >
  ...
  <Card
    ...
    icon="user"
    href="/api-reference/affiliates/get-affiliate"
  >
  ...
  <Card
    ...
    icon="edit"
    href="/api-reference/affiliates/update-affiliate"
  >
  ...
  <Card
    ...
    icon="trash"
    href="/api-reference/affiliates/delete-affiliate"
  >
...
<CardGroup cols={2}>
  <Card
    title="Criar API Key"
    icon="key"
    href="https://app.affiliatus.io/dashboard/settings/api-keys"
  >
