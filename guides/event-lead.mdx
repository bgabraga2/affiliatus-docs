...
<AccordionGroup>
  <Accordion title="Trial e Demos" icon="flask">
    - `trial_signup` - Cadastro em trial gratuito
    - `trial_started` - Trial ativado
  ...
  <Accordion title="Formulários" icon="file-pen">
    ...
    - `consultation_request` - Pedido de consultoria
  </Accordion>
  
  <Accordion title="Marketing" icon="megaphone">
    - `newsletter_signup` - Inscrição na newsletter
    - `ebook_download` - Download de material
    - `webinar_registration` - Registro em webinar
  </Accordion>
  
  <Accordion title="E-commerce" icon="cart-shopping">
    - `add_to_cart` - Adicionou ao carrinho
    - `checkout_started` - Iniciou checkout
    - `wishlist_add` - Adicionou à lista de desejos
  </Accordion>
  
  <Accordion title="Engajamento" icon="heart">
    - `pricing_viewed` - Visualizou pricing
    - `feature_explored` - Explorou features
    - `video_watched` - Assistiu vídeo completo
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Evento Conversion" icon="shopping-cart" href="/guides/event-conversion">
