...
<Warning>
  **Pré-requisito:** A [SDK JavaScript](/integrations/sdk-javascript) deve estar instalada no seu site! 
  Ela é responsável por salvar o cookie com o código do afiliado. Esta integração Stripe é **complementar** à SDK.
</Warning>
...
<Note>
  **Papel da SDK:** Ela salva o código do afiliado em um cookie que dura 30 dias. 
  Seu backend lê esse cookie e passa para o Stripe via metadata.
</Note>
